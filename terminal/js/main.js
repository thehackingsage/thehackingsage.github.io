...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "root@linux:~$ ssh guest@hacktronian\nThe authenticity of host 'hacktronian' can't be established.\nECDSA key fingerprint is SHA256:QHRoZWhhY2tpbmdzYWdl.\nAre you sure you want to continue connecting (yes/no)? yes\nWarning: Permanently added 'hacktronian' (ECDSA) to the list of known hosts.\nguest@hacktronian's password:\nLinux 5.3.0-amd64 #1 SMP Debian 5.3.15-1linux1 x86_64\n\nuse 'help' command for more information.\nin order to skip text rolling, double click/touch anywhere.\n",
        ...
        username: "Username",/* Mr.SAGE | @thehackingsage */
        hostname: "Host",
        platform: "Platform",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        "instagram.txt": "https://instagram.com/thehackingsage",
        "twitter.txt": "https://twitter.com/thehackingsage",
        "github.txt": "https://github.com/thehackingsage",
        "youtube.txt": "https://youtube.com/hacktronian"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
